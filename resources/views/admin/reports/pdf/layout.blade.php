...
<head>
    ...
    <style>
        ...
        .summary-grid .value { font-size: 16px; font-weight: bold; color: #0d9488; }
        .summary-grid .label { font-size: 9px; color: #666; margin-top: 2px; }
        table { width: 100%; border-collapse: collapse; margin-top: 15px; font-size: 10px; }
        th { background: #0d9488; color: white; padding: 6px 5px; text-align: left; font-size: 10px; }
