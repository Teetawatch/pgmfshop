...
<head>
    ...
    <title><?php echo e($seoTitle ?? 'Progressive Movement Foundation Shop'); ?></title>
    <meta name="description" content="<?php echo e($seoDescription ?? 'ร้านค้าออนไลน์ Progressive Movement Foundation Shop รวมหนังสือ เสื้อผ้า และสินค้าคุณภาพ จัดส่งทั่วไทย'); ?>">
    <link rel="canonical" href="<?php echo e($seoCanonical ?? url()->current()); ?>">

    <!-- Open Graph -->
    <meta property="og:type" content="<?php echo e($seoOgType ?? 'website'); ?>">
    <meta property="og:title" content="<?php echo e($seoTitle ?? 'Progressive Movement Foundation Shop'); ?>">
    <meta property="og:description" content="<?php echo e($seoDescription ?? 'ร้านค้าออนไลน์ Progressive Movement Foundation Shop รวมหนังสือ เสื้อผ้า และสินค้าคุณภาพ จัดส่งทั่วไทย'); ?>">
    <meta property="og:url" content="<?php echo e($seoCanonical ?? url()->current()); ?>">
    <meta property="og:site_name" content="PGMF Shop">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($seoImage)): ?>
    <meta property="og:image" content="<?php echo e($seoImage); ?>">
    <meta property="og:image:alt" content="<?php echo e($seoTitle ?? 'PGMF Shop'); ?>">
    <?php else: ?>
    <meta property="og:image" content="<?php echo e(asset('images/pgmf-logo.jpg')); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <meta property="og:locale" content="th_TH">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($seoTitle ?? 'Progressive Movement Foundation Shop'); ?>">
    <meta name="twitter:description" content="<?php echo e($seoDescription ?? 'ร้านค้าออนไลน์ Progressive Movement Foundation Shop รวมหนังสือ เสื้อผ้า และสินค้าคุณภาพ จัดส่งทั่วไทย'); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($seoImage)): ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2213723188-0', $key);
...
<?php /**PATH C:\Project\pgmfshop\backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>