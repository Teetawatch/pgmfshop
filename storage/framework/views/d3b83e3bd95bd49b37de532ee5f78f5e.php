            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <img src="<?php echo e(Vite::asset('resources/images/Thai_QR_Payment_Logo-01.jpg')); ?>" alt="PromptPay" class="h-auto max-h-12 object-contain rounded-lg shadow-sm">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <img src="<?php echo e(Vite::asset('resources/images/ThailandPost_Logo.svg')); ?>" alt="ไปรษณีย์ไทย" class="h-12 object-contain">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="space-y-3">
                <a href="/" class="inline-flex items-center gap-2 mb-1">
                    <img src="<?php echo e(Vite::asset('resources/images/pgmf-logo.jpg')); ?>" alt="PGMF Shop" class="h-8 w-8 rounded-lg object-cover" />
            ...
            <div class="space-y-3">
                ...
                <div class="space-y-1.5 text-xs">
                    <a href="<?php echo e(route('about')); ?>" class="block text-gray-500 hover:text-gray-800">รายละเอียดร้าน</a>
                    <a href="<?php echo e(route('faq')); ?>" class="block text-gray-500 hover:text-gray-800">คำถามที่พบบ่อย</a>
                    <a href="<?php echo e(route('how-to-order')); ?>" class="block text-gray-500 hover:text-gray-800">วิธีการสั่งซื้อ</a>
                    <a href="<?php echo e(route('privacy')); ?>" class="block text-gray-500 hover:text-gray-800">นโยบายความเป็นส่วนตัว</a>
                </div>
            </div>
            <div class="space-y-3">
                <h3 class="text-sm font-bold text-gray-800">ซื้อสินค้า</h3>
                <div class="space-y-1.5 text-xs">
                    <a href="<?php echo e(route('products')); ?>" class="block text-gray-500 hover:text-gray-800">สินค้าทั้งหมด</a>
                    <a href="<?php echo e(route('products', ['category' => 'สินค้าที่ระลึก'])); ?>" class="block text-gray-500 hover:text-gray-800">สินค้าที่ระลึก</a>
                    <a href="<?php echo e(route('products', ['category' => 'หนังสือ'])); ?>" class="block text-gray-500 hover:text-gray-800">หนังสือ</a>
                    <a href="<?php echo e(route('products', ['category' => 'รวมเรื่องสั้น'])); ?>" class="block text-gray-500 hover:text-gray-800">รวมเรื่องสั้น</a>
                    <a href="<?php echo e(route('products', ['category' => 'เรื่องเล่าจากต่างแดน'])); ?>" class="block text-gray-500 hover:text-gray-800">เรื่องเล่าจากต่างแดน</a>
                    <a href="<?php echo e(route('products', ['category' => 'นิยาย'])); ?>" class="block text-gray-500 hover:text-gray-800">นิยาย</a>
                    <a href="<?php echo e(route('products', ['category' => 'ความรู้อ่านสนุก'])); ?>" class="block text-gray-500 hover:text-gray-800">ความรู้อ่านสนุก</a>
                    <a href="<?php echo e(route('account.orders')); ?>" class="block text-gray-500 hover:text-gray-800">ติดตามคำสั่งซื้อ</a>
                </div>
            </div>
            <div class="space-y-3">
...
<?php /**PATH C:\Project\pgmfshop\backend\resources\views/partials/footer.blade.php ENDPATH**/ ?>