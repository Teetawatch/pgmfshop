...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
    <div class="bg-white rounded-xl p-5 border">
        ...
        <p class="text-2xl font-bold text-gray-800">฿<?php echo e(number_format($stats['total_revenue'], 0)); ?></p>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800">฿<?php echo e(number_format($stats['today_revenue'], 0)); ?></p>
        <p class="text-[10px] text-gray-400 mt-0.5"><?php echo e($stats['today_orders']); ?> คำสั่งซื้อวันนี้</p>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800">฿<?php echo e(number_format($stats['month_revenue'], 0)); ?></p>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['total_orders'])); ?></p>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['pending_orders'] > 0): ?>
            <p class="text-[10px] text-orange-500 mt-0.5"><?php echo e($stats['pending_orders']); ?> รอดำเนินการ</p>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-xl p-5 border">
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['total_products'])); ?></p>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['low_stock'] > 0): ?>
            <p class="text-[10px] text-red-500 mt-0.5"><?php echo e($stats['low_stock']); ?> สต็อกต่ำ</p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['total_customers'])); ?></p>
        <p class="text-[10px] text-teal-600 mt-0.5">+<?php echo e($stats['new_customers_month']); ?> เดือนนี้</p>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($stats['total_reviews'])); ?></p>
        <p class="text-[10px] text-yellow-600 mt-0.5">เฉลี่ย <?php echo e($stats['avg_rating']); ?> ดาว</p>
    </div>
    <div class="bg-white rounded-xl p-5 border">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-2xl font-bold text-gray-800"><?php echo e($stats['active_coupons']); ?></p>
    ...
    <div class="bg-white rounded-xl border">
        ...
        <div class="p-5 flex flex-col items-center">
            ...
            <div class="mt-4 grid grid-cols-2 gap-x-6 gap-y-1.5 text-xs w-full">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statusLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => [$label, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($statusDist[$key]) && $statusDist[$key] > 0): ?>
                        <div class="flex items-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full <?php echo e($color); ?> shrink-0"></span>
                            <span class="text-gray-600"><?php echo e($label); ?></span>
                            <span class="ml-auto font-semibold text-gray-800"><?php echo e($statusDist[$key]); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-xl border">
        <div class="px-5 py-4 border-b flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-xs text-teal-600 hover:underline">ดูทั้งหมด</a>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-3">
                            <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="text-teal-600 hover:underline font-medium"><?php echo e($order->order_number); ?></a>
                        </td>
                        <td class="px-5 py-3 text-gray-600"><?php echo e($order->user->name ?? '-'); ?></td>
                        <td class="px-5 py-3 text-right font-medium">฿<?php echo e(number_format($order->total, 0)); ?></td>
                        <td class="px-5 py-3 text-center">
                            ...
                            ?>
                            <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-medium <?php echo e($colors[$order->status] ?? 'bg-gray-100 text-gray-600'); ?>">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border">
            <div class="px-5 py-4 border-b flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.products.index')); ?>" class="text-xs text-teal-600 hover:underline">ดูทั้งหมด</a>
            </div>
            <div class="divide-y">
                ...
                <div class="px-5 py-3 flex items-center gap-3">
                    <span class="w-5 h-5 rounded-full <?php echo e($i < 3 ? 'bg-yellow-100 text-yellow-700' : 'bg-gray-100 text-gray-500'); ?> flex items-center justify-center text-[10px] font-bold"><?php echo e($i + 1); ?></span>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-700 truncate"><?php echo e($product->name); ?></p>
                        <p class="text-[10px] text-gray-400"><?php echo e($product->category->name ?? ''); ?> · สต็อก <?php echo e($product->stock); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm font-bold text-gray-800"><?php echo e(number_format($product->sold)); ?></p>
        ...
        <div class="bg-white rounded-xl border">
            ...
            <div class="divide-y">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="px-5 py-3">
                    <div class="flex items-center justify-between mb-1">
                        <p class="text-xs font-medium text-gray-700 truncate"><?php echo e($review->user->name ?? 'ผู้ใช้'); ?></p>
                        <div class="flex gap-0.5 shrink-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($star = 1; $star <= 5; $star++): ?>
                                <svg class="h-3 w-3 <?php echo e($star <= $review->rating ? 'text-yellow-400 fill-yellow-400' : 'text-gray-200'); ?>" viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 truncate"><?php echo e($review->product->name ?? ''); ?></p>
                    <p class="text-xs text-gray-400 mt-0.5 line-clamp-2"><?php echo e(Str::limit($review->comment, 80)); ?></p>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('monthlyRevenueChart'), {
        ...
        data: {
            ...
            datasets: [{
                label: 'รายได้ (฿)',
                data: <?php echo json_encode($monthRevenueData, 15, 512) ?>,
    ...
    const statusData = <?php echo json_encode($statusDist, 15, 512) ?>;
    const statusConfig = {
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\pgmfshop\backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>